                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="hero-nav-area">
                            <h1 class="text-white">اخبار دسته بندی
                                <?= $category['name'] ?></h1>
                        </div>
                    </div>
                            ...
                            <?php foreach ($categoryPosts as $categoryPost) { ?>
                                <div class="single-latest-post row align-items-center">
                                                        ...
                                                        <div class="col-lg-7 post-right">
                                                                <a href="<?= url('show/' . $categoryPost['id']) ?>">
                        ...
                        <div class="popular-post-wrap">
                                                ...
                                                <div class="feature-post relative">
                                                        ...
                                                        <div class="details">
                                                                ...
                                                                <a href="<?= url('show/' . $popularPosts[0]['id']) ?>">
                                                ...
                                                <?php if(isset($popularPosts[1])) { ?>
                                                        ...
                                                        <div class="col-lg-6 single-popular-post">
                                                                ...
                                                                <div class="details">
                                                                        <a href="<?= url('show/' . $popularPosts[1]['id']) ?>">
                                                        ...
                                                        <div class="col-lg-6 single-popular-post">
                                                                <div class="feature-img-wrap relative">
                                                                        ...
                                                                        <ul class="tags">
                                                                                <li><a href="<?= url('show/' . $popularPosts[2]['id']) ?>"><?= $popularPosts[2]['category'] ?></a></li>
                                                                        </ul>
                                                                </div>
                                                                <div class="details">
